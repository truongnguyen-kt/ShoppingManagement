...
<html>
    ...
    <body>
        ...
        <!-- Products Start --> <!-- Display Image Product -->
                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href="mainController?action=addtocart&pid=<%= p.getId()%>&check=0"><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="mainController?action=Favorite&pid=<%= p.getId()%>"><i class="far fa-heart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="getPlantServlet?pid=<%= p.getId()%>"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
